...
const RULES: Rule[] = [
  { code: "A", why: "LMIV Anhang II Nr. 1 — glutenhaltiges Getreide",
    words: ["pizza", "pasta", "linguine", "tagliatelle", "ravioli", "lasagna", "tortellacci", "pappardelle", "sombreri", "gnocchi", "weizen", "brot"] },
  ...
  { code: "D", why: "Nr. 4 — Fische",
    words: ["salmone", "tonno", "tonnata", "tonnato", "acciughe", "rombo", "branzino", "baccalà", "orata", "pesce", "pescatrice", "lachs", "thunfisch", "seeteufel", "goldbrassefilets"] },
  { code: "E", why: "Nr. 5 — Erdnuesse", words: ["arachidi", "erdnuss", "erdnüsse"] },
  { code: "F", why: "Nr. 6 — Sojabohnen", words: ["soia", "soja"] },
  { code: "G", why: "Nr. 7 — Milch",
    words: ["mozzarella", "bufala", "burrata", "ricotta", "scamorza", "gorgonzola", "grana", "parmigiano", "pecorino", "caprino", "mascarpone", "panna", "burro", "formaggio", "latte", "cappuccino", "käse", "sahne"] },
