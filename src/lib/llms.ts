...
export function buildLlmsTxt(lang: LlmsLang): string {
  ...
  if (lang === "de") {
    return [
      `# ${SITE.name}`,
      "",
      `> Italienisches Restaurant im Stuttgarter Westen. Italienisch verliebte Küche mit frischen Zutaten — Antipasti, Pasta, Pizze, Carne e Pesce, Dolci. Neben der festen Speisekarte gibt es jede Woche eine eigene Wochenkarte, aus der Stammgäste besonders gern bestellen.`,
      "",
      ...
      "## Speisekarten",
      "",
      `- [Wochenkarte](${u}/wochenkarte): Die wöchentlich wechselnde Karte der Küche mit Vorspeisen, Pasta, Pizza, Hauptgerichten, Desserts und Weinempfehlungen. Aktueller Stand: ${updated}.`,
  ...
  return [
    `# ${SITE.name}`,
    "",
    `> Italian restaurant in the west of Stuttgart, Germany. Italian cooking with fresh ingredients — antipasti, pasta, pizza, meat and fish, desserts. Besides the regular menu, the kitchen publishes a weekly menu (German: "Wochenkarte") every week; it is the menu regular guests order from most.`,
    "",
    ...
    "## Menus",
    "",
    `- [Weekly menu (Wochenkarte)](${u}/wochenkarte): The kitchen's menu of the week — starters, pasta, pizza, mains, desserts and wine recommendations. Current as of ${updated}.`,
