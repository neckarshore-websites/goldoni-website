 ...
 * portiert (2026-06-12). Kostenlos + unbegrenzt (kein Free-Tier-Limit /
 * Paid-Risiko), DSGVO-konform (kein Cookie, kein Cross-Site-Tracking,
 * EU-Datenverarbeitung möglich), unsichtbar/non-interactive im Normalfall.
 * Server-Verifikation: lib/captcha/verify.ts (siteverify).
 *
